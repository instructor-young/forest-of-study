  ...
  return (
    <button onClick={handleClick} className="aspect-square relative">
      <img
        ...
        className="cursor-pointer w-full h-full border border-black/10 rounded-2xl hover:brightness-95 active:brightness-90 transition data-[is-selected='true']:brightness-75 object-cover"
      />
      {isSelected && (
        <img
          src={SeletedIcon}
